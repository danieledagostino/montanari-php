...
use Montanari\Propel\UserSettings;
use Montanari\Propel\UserSettingsQuery;
...
class UserSettingsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Montanari.Propel.Map.UserSettingsTableMap';
     ...
     */
    const OM_CLASS = '\\Montanari\\Propel\\UserSettings';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Montanari.Propel.UserSettings';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UserSettingsTableMap::COL_ID_USER, UserSettingsTableMap::COL_PUSH_MESSAGE, UserSettingsTableMap::COL_EMAIL_MESSAGE, UserSettingsTableMap::COL_EMAIL_CAR_SUMMARY, UserSettingsTableMap::COL_EMAIL_EVENT_SUMMARY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UserSettingsTableMap::COL_ID_USER => 0, UserSettingsTableMap::COL_PUSH_MESSAGE => 1, UserSettingsTableMap::COL_EMAIL_MESSAGE => 2, UserSettingsTableMap::COL_EMAIL_CAR_SUMMARY => 3, UserSettingsTableMap::COL_EMAIL_EVENT_SUMMARY => 4, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Montanari\\Propel\\UserSettings');
        $this->setPackage('Montanari.Propel');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_user', 'IdUser', 'INTEGER' , 'users', 'id', true, null, null);
        ...
        $this->addColumn('email_event_summary', 'EmailEventSummary', 'VARCHAR', false, 2, 'si');
    } // initialize()
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UserSettingsTableMap::COL_ID_USER);
            $criteria->addSelectColumn(UserSettingsTableMap::COL_PUSH_MESSAGE);
            $criteria->addSelectColumn(UserSettingsTableMap::COL_EMAIL_MESSAGE);
            $criteria->addSelectColumn(UserSettingsTableMap::COL_EMAIL_CAR_SUMMARY);
            $criteria->addSelectColumn(UserSettingsTableMap::COL_EMAIL_EVENT_SUMMARY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Montanari\Propel\UserSettings) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(UserSettingsTableMap::DATABASE_NAME);
            $criteria->add(UserSettingsTableMap::COL_ID_USER, (array) $values, Criteria::IN);
        }
