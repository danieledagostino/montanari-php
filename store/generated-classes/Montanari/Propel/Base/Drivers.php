...
/**
 * Base class that represents a row from the 'drivers' table.
 *
 *
 *
 * @package    propel.generator.Montanari.Propel.Base
 */
abstract class Drivers implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Montanari\\Propel\\Map\\DriversTableMap';
    ...
    /**
     * The value for the seats_number field.
     *
    ...
    /**
     * Initializes internal state of Montanari\Propel\Base\Drivers object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Drivers</code> instance.  If
     * <code>obj</code> is an instance of <code>Drivers</code>, delegates to
     * <code>equals(Drivers)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Drivers The current object, for fluid interface
     */
    ...
    /**
     * Get the [seats_number] column value.
     *
     * @return int
     */
     ...
     * @return $this|\Montanari\Propel\Drivers The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DriversTableMap::COL_ID] = true;
        }
    ...
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[DriversTableMap::COL_ID_USER] = true;
        }
    ...
    public function setInsertDate($v)
    {
        ...
        if ($this->insert_date !== null || $dt !== null) {
            if ($this->insert_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->insert_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DriversTableMap::COL_INSERT_DATE] = true;
            }
    ...
    public function setIdEvent($v)
    {
        ...
        if ($this->id_event !== $v) {
            $this->id_event = $v;
            $this->modifiedColumns[DriversTableMap::COL_ID_EVENT] = true;
        }
    ...
    /**
     * Set the value of [road] column.
     *
     * @param string $v new value
     * @return $this|\Montanari\Propel\Drivers The current object (for fluent API support)
     */
    public function setRoad($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->road !== $v) {
            $this->road = $v;
            $this->modifiedColumns[DriversTableMap::COL_ROAD] = true;
        }
    ...
    /**
     * Set the value of [seats_number] column.
     *
     * @param int $v new value
     * @return $this|\Montanari\Propel\Drivers The current object (for fluent API support)
     */
    public function setSeatsNumber($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->seats_number !== $v) {
            $this->seats_number = $v;
            $this->modifiedColumns[DriversTableMap::COL_SEATS_NUMBER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DriversTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DriversTableMap::translateFieldName('IdUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DriversTableMap::translateFieldName('InsertDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->insert_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DriversTableMap::translateFieldName('IdEvent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_event = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DriversTableMap::translateFieldName('Road', TableMap::TYPE_PHPNAME, $indexType)];
            $this->road = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DriversTableMap::translateFieldName('SeatsNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->seats_number = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = DriversTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Montanari\\Propel\\Drivers'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDriversQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Drivers::setDeleted()
     * @see Drivers::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDriversQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DriversTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DriversTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(DriversTableMap::COL_ID_USER)) {
            $modifiedColumns[':p' . $index++]  = 'id_user';
        }
        if ($this->isColumnModified(DriversTableMap::COL_INSERT_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'insert_date';
        }
        if ($this->isColumnModified(DriversTableMap::COL_ID_EVENT)) {
            $modifiedColumns[':p' . $index++]  = 'id_event';
        }
        if ($this->isColumnModified(DriversTableMap::COL_ROAD)) {
            $modifiedColumns[':p' . $index++]  = 'road';
        }
        if ($this->isColumnModified(DriversTableMap::COL_SEATS_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'seats_number';
        }

        $sql = sprintf(
            'INSERT INTO drivers (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'id_event':
                        ...
                        break;
                    case 'road':
                        $stmt->bindValue($identifier, $this->road, PDO::PARAM_STR);
                        break;
                    case 'seats_number':
                        $stmt->bindValue($identifier, $this->seats_number, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = DriversTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Drivers'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Drivers'][$this->hashCode()] = true;
        $keys = DriversTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Montanari\Propel\Drivers
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setRoad($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setSeatsNumber($arr[$keys[5]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Montanari\Propel\Drivers The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DriversTableMap::COL_ID)) {
            $criteria->add(DriversTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DriversTableMap::COL_ID_USER)) {
            $criteria->add(DriversTableMap::COL_ID_USER, $this->id_user);
        }
        if ($this->isColumnModified(DriversTableMap::COL_INSERT_DATE)) {
            $criteria->add(DriversTableMap::COL_INSERT_DATE, $this->insert_date);
        }
        if ($this->isColumnModified(DriversTableMap::COL_ID_EVENT)) {
            $criteria->add(DriversTableMap::COL_ID_EVENT, $this->id_event);
        }
        if ($this->isColumnModified(DriversTableMap::COL_ROAD)) {
            $criteria->add(DriversTableMap::COL_ROAD, $this->road);
        }
        if ($this->isColumnModified(DriversTableMap::COL_SEATS_NUMBER)) {
            $criteria->add(DriversTableMap::COL_SEATS_NUMBER, $this->seats_number);
        }
    ...
    {
        $criteria = ChildDriversQuery::create();
        $criteria->add(DriversTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Montanari\Propel\Drivers (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRoad($this->getRoad());
        $copyObj->setSeatsNumber($this->getSeatsNumber());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Montanari\Propel\Drivers Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildDrivers is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildDrivers The current object (for fluent API support)
     */
    public function setCarOrganizations(Collection $carOrganizations, ConnectionInterface $con = null)
    {
        ...
        foreach ($carOrganizationsToDelete as $carOrganizationRemoved) {
            $carOrganizationRemoved->setDriver(null);
        }
    ...
    protected function doAddCarOrganization(ChildCarOrganization $carOrganization)
    {
        ...
        $carOrganization->setDriver($this);
    }
    ...
    public function removeCarOrganization(ChildCarOrganization $carOrganization)
    {
        if ($this->getCarOrganizations()->contains($carOrganization)) {
            ...
            $carOrganization->setDriver(null);
        }
     ...
     * Otherwise if this Drivers is new, it will return
     * an empty collection; or if this Drivers has previously
     * been saved, it will retrieve related CarOrganizations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Drivers.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aUsers) {
            $this->aUsers->removeDrivers($this);
        }
        if (null !== $this->aEvents) {
            $this->aEvents->removeDrivers($this);
        }
        $this->id = null;
        $this->id_user = null;
    ...
    {
        return (string) $this->exportTo(DriversTableMap::DEFAULT_STRING_FORMAT);
    }
